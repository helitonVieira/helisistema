...
public Pessoa fromDTO(PessoaDTO objDto) {
	return new Pessoa(objDto.getCod_pessoa(), objDto.getNom_pessoa(),objDto.getNom_fantasia(), objDto.getNum_cnpj_cpf(),
			          objDto.getNum_ie_rg(), objDto.getDta_nascimento(), objDto.getNom_responsavel(),objDto.getDes_observacao(),
			          objDto.getDta_cadastro(),objDto.getInd_cliente(), objDto.getInd_fornecedor(),objDto.getInd_funcionario(),
			          objDto.getInd_ativo(),null);//tipo pessoa 
}

public Pessoa fromDTO(PessoaNewDTO objDto) {
	Pessoa cli = new Pessoa(null,  objDto.getNom_pessoa(), objDto.getNom_fantasia(),			 
			 ...
			 objDto.getInd_cliente(),  objDto.getInd_fornecedor(),  objDto.getInd_funcionario(), 
			 objDto.getInd_ativo(),  TipoPessoa.toEnum(objDto.getCod_tipo_pessoa())); //pe.encode(objDto.getSenha()));
			
		
	Cidade cid = cidadeRepository.findOne(objDto.getCod_cidade());  
	Endereco end = new Endereco(null, objDto.getDes_logradouro(), objDto.getDes_num_logradouro(), objDto.getDes_complemento(),
			objDto.getDes_bairro(), objDto.getNum_cep(), cli, cid);
